-- Paridade mockup: valor estimado por benefício (R$/ano). Aditiva, nullable —
-- o app cai no placeholder quando ausente. Mockups mostram "≈ R$ X/ano" no
-- detalhe e somam no radar/painel.
alter table benefits add column estimated_value_brl int;

-- Recria my_benefits expondo o valor (mesma def de 0013 + estimated_value_brl).
